	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-success"  style="position: sticky; top: -1px; z-index: 1;">
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContentLG">
	        <ul class="navbar-nav mr-auto">
			   ...
			   <li id="na" class="nav-item active"><a class="nav-link" href="LsmuahangController">Lịch sử mua hàng</a></li>
	        </ul>
	        <form class="form-inline my-2 my-lg-0" method="post" action="LsmuahangController" style="display: none;">
	...
	<div class="container-fluit">
		<div class="row" style="background-color: palegreen; margin-right: 0px;">
			<div class="col-xs-8 col-sm-9 col-md-9">
				...
				<%
				ArrayList<hoadonbean> ds = (ArrayList<hoadonbean>)request.getAttribute("lsmh");
				if(ds!=null){
						for(hoadonbean g: ds){
				%>
					<tr>
			...
			<div class="col-xs-4 col-sm-3 col-md-3">
				<div style="width: 90px; height: 200px;">
